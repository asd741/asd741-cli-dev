...
const { readFile, writeFile, spinnerStart } = require('@asd741-cli-dev/utils');
const request = require('@asd741-cli-dev/request');
const CloudBuild = require('@asd741-cli-dev/cloudbuild');
...
class Git {
  constructor({ name, version, dir }, {
    ...
    if (name.startsWith('@') && name.indexOf('/') > 0) {
      // @asd741-cli-dev/component-test ->
      // asd741-cli-dev_component-test
